...
{
    public class OrganizationModel : ObservableItem, IIdentifiable
    {
        ...
        public static IList<OrganizationModel> GetList(string searchName = "", OrganizationType? organizationType = null, Country? country = null)
        {
            using var dc = new Dc();
